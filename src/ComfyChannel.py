...
SERVER_VIDEO_BITRATE = '1200k'
SERVER_MAXRATE = '1200k'
SERVER_BUFSIZE = '2400k'
SERVER_AUDIO_BITRATE = '168k'
...
CLIENT_VIDEO_BITRATE = '1200k'  # fixed video bitrate
...
class Server:
    ...
    def start(self):
        ...
        self.ff = ffmpeg.output(joined, self.output,
                                ...
                                b=SERVER_VIDEO_BITRATE,
                                maxrate=SERVER_MAXRATE,
                                bufsize=SERVER_BUFSIZE,
                                crf=SERV_OUTPUT_CRF,
                                tune='zerolatency',
                                acodec=SERV_OUTPUT_ACODEC,
                                ab=SERVER_AUDIO_BITRATE,
                                preset=PRESET,
