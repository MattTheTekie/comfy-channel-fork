...
My personal fork of Comfy Channel ([Code based on TheDerpySage's fork](https://github.com/TheDerpySage/comfy-channel)) with fixes for running in modern systems without issues alongside a complete fix for the gradual desyncing and the major buffering issues caused from the previous code base.
